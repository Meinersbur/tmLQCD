...
#define HALO_SITES (2*PHYSICAL_LXV*PHYSICAL_LY*PHYSICAL_LZ + 2*PHYSICAL_LTV*PHYSICAL_LY*PHYSICAL_LZ + 2*PHYSICAL_LTV*PHYSICAL_LX*PHYSICAL_LZ)
...
enum {
	...
	BGQREF_TDOWN_SENDBUF,
	BGQREF_TDOWN_RECVBUF,
	BGQREF_XDOWN_SENDBUF,
	BGQREF_XDOWN_RECVBUF,
	BGQREF_YUP,
	BGQREF_YDOWN,
	BGQREF_ZUP,
	BGQREF_ZDOWN,
