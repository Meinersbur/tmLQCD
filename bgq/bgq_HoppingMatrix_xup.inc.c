...
void bgq_HoppingMatrix_site_xup(bgq_spinorfield_double targetfield, bgq_spinorfield_double spinorfield, bgq_gaugefield_double gaugefield, bool isOdd, int x, int y, int z, int tv, int k, int z1, int z2) {
...
#endif
	{
		...
		bgq_spinorsite_double *spinorsite_xup = BGQ_SPINORSITE(spinorfield, !isOdd, t, x+1, y, zv, z1,z2);
		...
		bgq_su3_weyl_double_store(weylxchange_send_double[X_DOWN], weyl_xup);
#endif
