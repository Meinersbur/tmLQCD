...
void jderrorhandler(const int i, char * message) {
  /* GG */
  char gmalv[256];
  strcpy(gmalv, getenv("MALLOC_TRACE"));
  //  fprintf(stderr, "jdher err %d %s %s \n", i, message, gmalv);
  fprintf(stdout, "jdher err %d %s %s \n", i, message, gmalv); fflush(stdout);
