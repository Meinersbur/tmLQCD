...
./configure --with-lapack="-llapack" --with-limedir="${ROOTPATH}/lime" --enable-mpi --with-mpidimension=XYZ --enable-halfspinor CC="mpicc" CFLAGS="-g -O0 -fopenmp -Wall -Wundef -ftime-report"
